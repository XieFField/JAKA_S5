...
def generate_launch_description():
    node = Node(
        ...
        parameters=[{
            ...
            "configure_only": _parameter("configure_only", bool),
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("configure_only", default_value="false"),
        ...
        DeclareLaunchArgument("run_duration", default_value="1.0"),
        DeclareLaunchArgument("guard_timeout", default_value="2.0"),
